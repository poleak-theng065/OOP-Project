import { Authentication } from "../../InterfaceAuthenication/InterfaceAuthenication";
...
export class CustomerAuthentication implements Authentication {
  ...
  login(credentials: {
    ...
    const customer = this.customers.find(c => c.getEmail() === credentials.email);
